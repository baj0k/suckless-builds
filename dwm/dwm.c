...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int isfixed, isfloating, isalwaysontop, isurgent, neverfocus, oldstate, isfullscreen, isterminal, noswallow, cantfocus, issticky;
	pid_t pid;
	int hasfloatbw;
	Client *next;
	Client *snext;
...
{
	char buf[16];
	FILE *fp = popen("/usr/bin/pidof -s dwmblocks", "r");
